// ========================================
// KILL-SWITCH - TEST VERSION (15:45 Uhr)
// ========================================
const EXPIRY_DATE = new Date('2026-02-03T15:45:00');
const now = new Date();

console.log('=== SERVICE WORKER KILL-SWITCH TEST (15:45 Uhr) ===');
...
if (now > EXPIRY_DATE) {
        ...
        ">
          ...
          ">
            ...
            <div style="
              ...
              color: #fbbf24;
            ">
              🧪 TEST-VERSION (Service Worker - 15:45 Uhr)
            </div>
          </div>
        </body>
        </html>
  ...
  throw new Error('Beta-Phase beendet - Service Worker gesperrt (TEST 15:45)');
}

// ========================================
// NORMALER SERVICE WORKER CODE
// ========================================
const CACHE_NAME = 'checkout-world-v2-TEST-1545';
const urlsToCache = [
  './',
  './index.html',
  './style.css',
